...
class ColorApproximator:
    ...
    def __init__(self):
        ...
        self.color_mapping = {
            ...
            "Light Magenta": QColor(255, 150, 255), "Steel": QColor(176, 196, 222),
            "Slate Blue": QColor(100, 100, 200),
            ...
            "Pale Yellow": QColor(255, 255, 150), "Sand": QColor(244, 164, 96),
            ...
            "Vivid Pink": QColor(255, 0, 127),

            # More Vibrant Colors
            "Neon Blue": QColor(50, 137, 255),"Neon Green": QColor(57, 255, 20),
            ...
            "Rose": QColor(255, 102, 178), "Tangerine": QColor(255, 128, 0),
            ...
            "Forest": QColor(34, 139, 34), "Rainforest": QColor(26, 77, 55),
            ...
            # Deep & Dark Shades
            "Midnight": QColor(25, 25, 112), "Jet": QColor(52, 52, 52),
            ...
            "Lemonade": QColor(255, 253, 115), "Ash Gray": QColor(229, 228, 226),
            ...
            "Fuchsia": QColor(255, 0, 255), "Turquoise": QColor(80, 160, 160),
